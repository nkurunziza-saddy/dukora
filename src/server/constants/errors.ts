...
export const ERROR_CODE_STATUS_MAP: Record<ErrorCode, number> = {
  [ErrorCode.STRIPE_ACCOUNT_NOT_CONNECTED]: 400,
  [ErrorCode.RECEIVER_STRIPE_ACCOUNT_NOT_CONNECTED]: 400,
  // General errors
  [ErrorCode.INTERNAL_SERVER_ERROR]: 500,
  [ErrorCode.BAD_REQUEST]: 400,
  [ErrorCode.UNAUTHORIZED]: 401,
  [ErrorCode.FORBIDDEN]: 403,
  [ErrorCode.CANNOT_DELETE]: 403,
  ...
  // Analytics errors
  [ErrorCode.BEFORE_BUSINESS_CREATION]: 400,
