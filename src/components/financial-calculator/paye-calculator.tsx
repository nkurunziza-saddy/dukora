    ...
    <Card className="w-full max-w-md">
      ...
      <CardContent className="grid gap-4">
        <div className="grid gap-2">
          <Label htmlFor="monthlyIncome">{t('paye_calculator.monthly_income_label')}</Label>
          <Input
            id="monthlyIncome"
            type="number"
            value={monthlyIncome}
        ...
        <div className="grid gap-2">
          <Label htmlFor="employeeType">{t('paye_calculator.employee_type_label')}</Label>
          <Select value={employeeType} onValueChange={setEmployeeType}>
            <SelectTrigger id="employeeType">
              <SelectValue placeholder={t('paye_calculator.select_employee_type')} />
            </SelectTrigger>
            <SelectContent>
              <SelectItem value="permanent">{t('paye_calculator.permanent_employee')}</SelectItem>
              <SelectItem value="casual">{t('paye_calculator.casual_laborer')}</SelectItem>
            </SelectContent>
          </Select>
        </div>
        <div className="grid gap-2">
