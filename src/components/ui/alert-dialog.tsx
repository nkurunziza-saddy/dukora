  ...
  return (
    <AlertDialogPortal>
      ...
      <div className="fixed inset-0 z-50">
        <div className="flex h-[100dvh] flex-col items-center overflow-hidden pt-6 max-sm:before:flex-1 sm:overflow-y-auto sm:p-4 sm:after:flex-1">
          <AlertDialogPrimitive.Popup
            ...
            className={cn(
              ...
              "relative sm:data-nested:data-ending-style:translate-y-8 sm:data-nested:data-starting-style:translate-y-8 dark:shadow-lg dark:shadow-black/24",
              className,
            )}
            {...props}
          />
