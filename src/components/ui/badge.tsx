  ...
  "inline-flex items-center justify-center rounded-md border px-2 py-0.5 text-xs font-medium w-fit whitespace-nowrap shrink-0 [&>svg]:size-3 gap-1 [&>svg]:pointer-events-none focus-visible:border-ring focus-visible:ring-ring/50 focus-visible:ring-[3px] aria-invalid:ring-destructive/20 dark:aria-invalid:ring-destructive/40 aria-invalid:border-destructive transition-[color,box-shadow] overflow-hidden",
  {
    variants: {
      variant: {
        ...
        green:
          "bg-green-50 text-green-800 ring-1 ring-inset ring-green-600/20 dark:bg-green-900/40 backdrop-blur-sm dark:text-green-200 dark:ring-green-400/20",
        blue: "bg-blue-50 text-blue-800 ring-1 ring-inset ring-blue-600/20 dark:bg-blue-900/40 backdrop-blur-sm dark:text-blue-200 dark:ring-blue-400/20",
        teal: "bg-teal-50 text-teal-800 ring-1 ring-inset ring-teal-600/20 dark:bg-teal-900/40 backdrop-blur-sm dark:text-teal-200 dark:ring-teal-400/20",
        yellow:
        ...
        red: "bg-red-50 text-red-800 ring-1 ring-inset ring-red-600/20 dark:bg-red-900/40 backdrop-blur-sm dark:text-red-200 dark:ring-red-400/20",
        redStrong:
        ...
        pink: "bg-pink-50 text-pink-800 ring-1 ring-inset ring-pink-600/20 dark:bg-pink-900/40 backdrop-blur-sm dark:text-pink-200 dark:ring-pink-400/20",
        indigo:
        ...
        gray: "bg-gray-50 text-gray-800 ring-1 ring-inset ring-gray-600/20 dark:bg-gray-900/40 backdrop-blur-sm dark:text-gray-200 dark:ring-gray-400/20",
        grayStrong:
