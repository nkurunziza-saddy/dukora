...
import { Brain, TrendingUp, DollarSign, AlertTriangle, BarChart3, Sparkles } from "lucide-react"
...
const insights = [
  {
    ...
    description: "Electronics category showing 32% increase in demand. Consider increasing inventory for Q1.",
    type: "trend",
    impact: "high"
  },
  {
    title: "Cost Optimization",
    description: "Furniture supplier pricing 15% above market average. Review contracts recommended.",
    type: "cost",
    impact: "medium"
  },
  {
    title: "Inventory Efficiency",
    description: "WH-North operating at 94% efficiency. Consider rebalancing stock across warehouses.",
    type: "efficiency",
    impact: "high"
  }
]
    ...
    <div className="p-6 space-y-6">
      ...
      <div className="flex items-center gap-4">
        ...
        <div>
          ...
          <p className="text-muted-foreground">AI-powered insights and predictive analytics for your inventory</p>
        </div>
      </div>
      ...
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold text-destructive">{kpiData.predictedStockouts}</div>
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold">{kpiData.forecastAccuracy}%</div>
      ...
      <div className="grid gap-6 lg:grid-cols-2">
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>Revenue comparison across all warehouse locations</CardDescription>
          </CardHeader>
            ...
            {warehouseData.map((warehouse, index) => (
              <div key={index} className="space-y-2">
                <div className="flex justify-between items-center">
                  ...
                  <span className="text-sm text-muted-foreground">${warehouse.value.toLocaleString()}</span>
                </div>
                <div className="flex items-center gap-2">
                  <Progress value={warehouse.percentage} className="flex-1" />
                  <span className="text-sm text-muted-foreground">{warehouse.percentage}%</span>
                </div>
              </div>
            ))}
            <div className="pt-4 border-t">
              <div className="flex justify-between text-sm">
                ...
                <span className="font-medium">
                  ${warehouseData.reduce((sum, item) => sum + item.value, 0).toLocaleString()}
                </span>
              </div>
            </div>
          </CardContent>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            AI-powered inventory recommendations based on demand forecasting and optimization
          </CardDescription>
        </CardHeader>
        <CardContent>
                ...
                <div className="flex items-start justify-between">
                  <div className="space-y-2 flex-1">
                    ...
                    <div className="flex items-center gap-4 text-sm">
                      ...
                      <span>→</span>
                      <span>Suggested: <strong>{rec.suggestedReorder}</strong></span>
                      <span className="text-green-600">Potential savings: ${rec.savings}</span>
                    </div>
                  </div>
          ...
          <div className="mt-6 p-4 bg-muted/20 rounded-lg">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-sm text-muted-foreground">By implementing all recommendations</p>
              </div>
              <div className="text-right">
                <p className="text-2xl font-bold text-green-600">
                  ${aiRecommendations.reduce((sum, rec) => sum + rec.savings, 0).toLocaleString()}
                </p>
