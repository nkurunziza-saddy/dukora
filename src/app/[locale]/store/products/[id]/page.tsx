import { ArrowLeftIcon, MinusIcon, PlusIcon, StarIcon } from "lucide-react";
...
export default async function ProductPage({
  ...
  const isOnSale = product.costPrice && parseFloat(product.costPrice) > parseFloat(product.price || "0");
