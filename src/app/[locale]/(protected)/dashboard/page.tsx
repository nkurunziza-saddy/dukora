        ...
        <div className="space-y-6">
          ...
          {inventoryItems && inventoryItems.length > 0 && (
            <Card>
              ...
              <CardPanel>
                <Table aria-label="Inventory items overview" role="table">
                  <TableHeader>
                    <TableRow>
                      <TableHead scope="col">{t("sku")}</TableHead>
                      <TableHead scope="col">{t("productName")}</TableHead>
                      <TableHead scope="col">{t("category")}</TableHead>
                      <TableHead scope="col">{t("warehouse")}</TableHead>
