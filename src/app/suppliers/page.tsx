...
const products = [
  { id: 1, sku: "WH-001", name: "Wireless Headphones", unitCost: 85.00 },
  { id: 2, sku: "KB-002", name: "Mechanical Keyboard", unitCost: 110.00 },
  { id: 3, sku: "MG-003", name: "Gaming Mouse", unitCost: 45.00 },
  { id: 4, sku: "TB-004", name: "Standing Desk", unitCost: 250.00 },
]
...
export default function SupplierManagement() {
  ...
  const totalOrderValue = orderItems.reduce((sum, item) => sum + (item.quantity * item.unitCost), 0)
                          ...
                          <TableRow key={index}>
                            <TableCell>
                              <Select
                                ...
                                onValueChange={(value) => {
                                  ...
                                  if (product) {
                                    updateOrderItem(index, "unitCost", product.unitCost)
                                  }
                                }}
                              >
                                <SelectTrigger>
                            ...
                            <TableCell>
                              <Input
                                ...
                                step="0.01"
                                value={item.unitCost || ""}
                                onChange={(e) => updateOrderItem(index, "unitCost", Number.parseFloat(e.target.value) || 0)}
                                placeholder="0.00"
                              />
                            </TableCell>
                            <TableCell>
