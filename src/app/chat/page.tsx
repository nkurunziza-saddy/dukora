...
import { Send, Bot, User, FileText, BarChart3, Package, Sparkles } from "lucide-react"
...
const initialMessages = [
  {
    id: 1,
    type: "assistant",
    content: "Hello! I'm your AI inventory assistant. I can help you with inventory management, generate reports, analyze trends, and answer questions about your stock. How can I assist you today?",
...
export default function AIChat() {
  ...
  const generateAIResponse = (prompt: string) => {
    ...
    if (lowercasePrompt.includes("stock") || lowercasePrompt.includes("inventory")) {
    ...
    if (lowercasePrompt.includes("sales") || lowercasePrompt.includes("report")) {
    ...
    if (lowercasePrompt.includes("reorder") || lowercasePrompt.includes("low")) {
    ...
    if (lowercasePrompt.includes("recommend") || lowercasePrompt.includes("optimize")) {
    ...
    <div className="p-6 space-y-6">
      ...
      <div className="flex items-center gap-4">
        ...
        <div>
          ...
          <p className="text-muted-foreground">Get instant help and insights for your inventory management</p>
        </div>
      </div>
        ...
        <div className="lg:col-span-3">
          <Card className="h-[600px] flex flex-col">
            <CardHeader>
              ...
              <CardDescription>Ask questions about your inventory and get instant insights</CardDescription>
            </CardHeader>
            ...
            <div className="p-4 border-t">
              ...
              <p className="text-xs text-muted-foreground mt-2">
                Press Enter to send or click the quick actions for common queries
              </p>
            </div>
          </Card>
        </div>
