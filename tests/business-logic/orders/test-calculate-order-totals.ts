...
function testCalculateOrderSubtotal() {
  ...
  assert(
    result3.value === 0 && result3.error === ERROR_CODE.MISSING_INPUT,
  ...
  assert(
    result4.error === ERROR_CODE.MISSING_INPUT,
...
function testCalculateOrderTax() {
  ...
  assert(
    result5.error === ERROR_CODE.MISSING_INPUT,
  ...
  assert(
    result6.error === ERROR_CODE.MISSING_INPUT,
...
function testCalculateAllOrderAmounts() {
  ...
  assert(
    result3.error === ERROR_CODE.MISSING_INPUT,
